...
export default function MP({img,title,desc,link}){
    ...
    return(
        <a href={link} className=''>
             <div className={` border m-0 p-2 text-left  text-gray-300 flex flex-wrap   hover:bg-gray-200 hover:text-gray-900 dark:bg-gray-500 dark:text-gray-900 dark:hover:text-gray-300  transform-cpu  hover:skew-x-6 focus:bg-slate-600`}>
