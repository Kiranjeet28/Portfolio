...
export default function MP({img,title,desc,link}){
    ...
    return(
        <a href={link} className=''>
             ...
             <div className={` text-gray-300  bg-gray-700     rounded-lg mx-10 my-3 border dark:border-black p-1  text-left   flex flex-wrap    hover:bg-gray-500 hover:text-black    transform-cpu  hover:skew-x-6 focus:bg-slate-600`}>
